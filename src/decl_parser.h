...
struct decl_specifiers {
    enum {s_c_none, s_c_typedef, s_c_extern, s_c_static, s_c_auto,
	s_c_register, }	storage_class; // only one may appear
    ...
    enum {t_s_typeless, t_s_char, t_s_int, t_s_float, t_s_double,
	t_s_void} core_type;
};
